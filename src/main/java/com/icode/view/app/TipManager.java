...
public class TipManager extends JComponent {
    ...
    private class Listener
            implements MouseListener, AncestorListener, ActionListener {
    ...
    private void showTip() {
        JComponent glassPane = (JComponent) ((RootPaneContainer) SwingUtilities.windowForComponent(target)).getGlassPane();

        FontMetrics fm = getFontMetrics(getFont());
        int w = 0, fh = fm.getHeight(), h = fm.getAscent() + fm.getDescent() + 12 + 6;
        ...
        int x = p.x + (target.getWidth()) / 2 - 18, y = p.y + target.getHeight();
     ...
     * @param component a JComponent object to add
     */
