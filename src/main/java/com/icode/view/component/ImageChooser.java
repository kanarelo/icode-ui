...
public class ImageChooser extends JFileChooser {
	...
	public ImageChooser(String title) {
		...
		addChoosableFileFilter(new FileFilter() {
			public boolean accept(File file) {
				...
				return file.isDirectory()
						...
						|| file.getAbsolutePath().endsWith(".ico");
			}
		...
		popupDialog = new PopupDialog(title, this, false);
	}
	...
	public boolean showModal(JComponent invoker) {
		return popupDialog.showModal(invoker);
	}
	
	public void showMessage(JComponent invoker) {
		popupDialog.showMessage(invoker);
	}
	
	private class ImagePreviewPanel extends JPanel implements
