...
public class MenuList extends JPanel
        implements AdjustmentListener, AncestorListener, WindowFocusListener, FocusListener, MouseListener, MouseWheelListener {
    ...
    protected void paintComponent(Graphics paramGraphics) {
        Border localBorder = UIManager.getBorder("List.sourceListBackgroundPainter");
        if (localBorder != null) {
            localBorder.paintBorder(this, paramGraphics, 0, 0, getWidth(), getHeight());
        } else {
            paramGraphics.setColor(new Color((this.windowFocused) ? 14081509 : 15263976));
    ...
    public static class Item extends JComponent
        ...
        public Dimension getPreferredSize() {
            ...
            return new Dimension(localFontMetrics.stringWidth(this.text) + 16, localFontMetrics.getAscent() + localFontMetrics.getDescent() + 8);
        }
        ...
        protected void paintComponent(Graphics paramGraphics) {
            ...
            if (i != 0) {
                Border localObject = UIManager.getBorder((bool2) ? "List.sourceListFocusedSelectionBackgroundPainter" : "sourceListSelectionBackgroundPainter");
                if (localObject != null) {
                    localObject.paintBorder(this, localGraphics2D, 0, 0, getWidth(), getHeight());
                } else {
                    paramGraphics.setColor(new Color((bool1) ? 9543872 : (bool2) ? 4554952 : 9934743));
                    paramGraphics.drawLine(0, 0, getWidth() - 1, 0);
                    localGraphics2D.setPaint(new GradientPaint(0.0F, 1.0F, new Color((bool1) ? 10662352 : (bool2) ? 6067158 : 11908533), 0.0F, getHeight() - 1, new Color((bool1) ? 7307946 : (bool2) ? 1463466 : 9079434)));
                    paramGraphics.fillRect(0, 1, getWidth(), getHeight() - 1);
                }
            }
            paramGraphics.setFont(UIManager.getFont((i != 0) ? "Label.boldfont" : "Label.font"));
            ...
            paramGraphics.setColor((i != 0) ? Color.white : new Color((bool1) ? 8233181 : 10921638));
            paramGraphics.fillRoundRect(l, 4, k + 8, ((FontMetrics) localObject).getAscent() + ((FontMetrics) localObject).getDescent(), 14, 14);
            paramGraphics.setColor((i != 0) ? Color.gray : (bool2) ? new Color(8233181) : Color.white);
            paramGraphics.drawString(this.count, l + 4, 4 + ((FontMetrics) localObject).getAscent());
        }
    ...
    public static class Group extends JComponent {
        ...
        public Dimension getPreferredSize() {
            FontMetrics localFontMetrics = getFontMetrics(getFont());
            return new Dimension(localFontMetrics.stringWidth(this.text) + 16, localFontMetrics.getAscent() + localFontMetrics.getDescent() + 12);
        }
        ...
        protected void paintComponent(Graphics paramGraphics) {
            ...
            paramGraphics.drawString(this.text, 8, 9 + localFontMetrics.getAscent());
            paramGraphics.setColor(getForeground());
            paramGraphics.drawString(this.text, 8, 8 + localFontMetrics.getAscent());
        }
    }
}
