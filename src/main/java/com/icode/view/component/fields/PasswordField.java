 ...
 */
public class PasswordField extends javax.swing.JPasswordField implements ValueEditor<Object> {
    ...
    public Object getContent() {
        String text = new String(this.getPassword());
    ...
    private class FieldDocument extends PlainDocument implements FocusListener {
        ...
        public void focusLost(FocusEvent e) {
            if (valid) {
                String text = new String(PasswordField.this.getPassword()).trim();
                String formatted = (text.isEmpty()) ? "" : getFormattedText(text);
    ...
    private void checkValidity() {
        String text = new String(PasswordField.this.getPassword()).trim();
        boolean v = (text.isEmpty()) ? !required : isValid(text);
        if (valid != v) {
            valid = v;
        }
    ...
    public void paint(Graphics g) {
        ...
        if (!valid) {
            paintStatus(g, this, required && (this.getPassword().length == 0));
        }
    }
